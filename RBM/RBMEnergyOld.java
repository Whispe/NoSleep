...
public class RBMEnergyOld {
	...
	public RBMEnergyOld(RBMParameters parameters, int numSamples) {
...
/*			System.out.println("Sample num: " + i + ":");
			System.out.println("h_s: ");
			for (int k=0; k<this.h_s[sampNum].length; k++) {
				System.out.print(this.h_s[sampNum][k] + " ");
			}
			System.out.println();
			System.out.println("x_s: ");
			for (int k=0; k<this.x_s[sampNum].length; k++) {
				System.out.print(this.x_s[sampNum][k] + " ");
			}
			System.out.println();*/
			this.numXSame += compX(sampNum);
			//System.out.println("numXSame: " + numXSame);
		}
